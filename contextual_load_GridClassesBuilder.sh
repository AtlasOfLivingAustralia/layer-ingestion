...
export LAYER_NAME=geo_feature_gridded
export LAYER_DESCRIPTION=Geomorphology_of_australian_seafloor
...
&& cp ${CLASSES_MAPPING_FILE} ${SHAPE_DIVA_DIR}/${LAYER_NAME}.txt \
