...
export UNITS="%"
export RAW_BIL_FILE="/data/ala/data/layers/raw/ga_bath_rocky"
...
&& java -Xmx10G -cp "${JAVA_CLASSPATH}" Bil2diva "${PROCESS_DIR}/${LAYER_NAME}/${LAYER_NAME}" "${DIVA_DIR}/${LAYER_NAME}" "${UNITS}" /
