...
export LAYER_ID=989
export LAYER_SHORT_NAME="gbr_gbr100" 
export LAYER_DISPLAY_NAME="Great Barrier Reef 100m DEM"
export UNITS="m"
...
&& gdalwarp -of EHdr -ot Float32 -t_srs EPSG:4326 "${RAW_BIL_FILE}" "${PROCESS_DIR}/${LAYER_SHORT_NAME}/${LAYER_SHORT_NAME}.bil" \
